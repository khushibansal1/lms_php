...
<button type="submit"  name="Buy"><a href="../checkout/checkout.php">Buy Now</a></button>
            </button>
            </form>
            </div>
            </div>
    ...
    <?php 
            ...
            $qry2="select lessonname from lesson_master where cid=".$_GET['cid'];
             ...
             while($row2=mysqli_fetch_array($res2))
             {
               ?>
            <div>
              <?php   echo $count++.'. '.$row2['lessonname']; ?>
             </div>
             <?php
