...
include('conn.php');
    ...
    if(@$_POST["email1"] =='admin@gmail.com' && $_POST["password"]=='admin123')
    {
        header("location:../../admin/html/light/index.php");
                ...
                <?php
                    ...
                    <form method="POST" id="signup-form" class="signup-form">
                     ...
                     <?php
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="email1" id="email" placeholder="Your Email"/>
                        </div>
                        <div class="form-group">
