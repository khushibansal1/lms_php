            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Text Courses List</li>
                    </ul>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>Total courses</h2>
                        <?php
                        $qry = "select count(cid) from courses_master where c_type='text course'";
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table border="1">
                                ...
                                <?php
                                $qry = "select cid,language,c_type,title,description,cat_id from courses_master where c_type='text course'";
