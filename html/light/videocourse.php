            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                class="fa fa-arrow-left"></i></a>List</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                        <li class="breadcrumb-item">Courses</li>
                        <li class="breadcrumb-item active">Video Courses List</li>
                    </ul>
                </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="header">
                        <h2>Total courses</h2>
                        <?php
                        $qry = "select count(cid) from courses_master  where c_type='Video course'";
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table border="1">
                                ...
                                <?php
                                $qry = "select cid,language,c_type,title,description,cat_id from courses_master where c_type='Video course'";
